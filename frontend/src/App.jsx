  ...
  return (
    <div style={{
      ...
      <div style={{ padding: "1.25rem 1.5rem", display: "flex", flexDirection: "column", gap: "1.25rem" }}>
        ...
        <section style={{ background: "#13151C", border: "1px solid #1E2028", borderRadius: "8px", overflow: "hidden" }}>
          <div style={{ padding: "0.75rem 1rem", borderBottom: "1px solid #1E2028",
            display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <span style={{ fontSize: "0.72rem", fontWeight: 600, color: "#888", letterSpacing: "0.1em" }}>
              REGISTERS
            </span>
            <span style={{ fontSize: "0.68rem", color: "#444" }}>
              Click a value to edit (R/W) · Edit to change metadata · + to add new
            </span>
          </div>
          {loading ? (
        ...
        <section style={{ background: "#13151C", border: "1px solid #1E2028", borderRadius: "8px", overflow: "hidden" }}>
          <div style={{ padding: "0.75rem 1rem", borderBottom: "1px solid #1E2028",
            ...
            <span style={{ fontSize: "0.68rem", color: "#444" }}>{changeLog.length} events</span>
          </div>
